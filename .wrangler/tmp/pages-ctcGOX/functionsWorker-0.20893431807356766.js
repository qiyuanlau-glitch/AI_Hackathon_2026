...
// agent-proxy.js
var ALLOWED_AGENT_HOSTS = /* @__PURE__ */ new Set(["meshstage.smsassist.com"]);
...
__name(validateAgentUrl, "validateAgentUrl");
function buildOneBrainBody(payload) {
  return { text: JSON.stringify(payload || {}) };
}
__name(buildOneBrainBody, "buildOneBrainBody");
...
__name(forwardAgentRequest, "forwardAgentRequest");
...
// ../.wrangler/tmp/pages-ctcGOX/functionsRoutes-0.7434567057995742.mjs
var routes = [
  {
